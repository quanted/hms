...
namespace HMSWebServices.Models
{
    public class WSBaseFlow
    {
        ...
        /// <param name="localTime"></param>
        /// <returns></returns>
        public HMSJSON.HMSJSON.HMSData GetBaseFlowDataObject(out string errorMsg, string latitude, string longitude, string startDate, string endDate, string dataSource, bool localTime)
        {
            errorMsg = "";
            HMSBaseFlow.BaseFlow bFlow = new HMSBaseFlow.BaseFlow(out errorMsg, latitude, longitude, startDate, endDate, dataSource, localTime, null);
        ...
        /// <param name="shapefileName"></param>
        /// <returns></returns>
        public HMSJSON.HMSJSON.HMSData GetBaseFlowDataObject(out string errorMsg, string startDate, string endDate, string dataSource, bool localTime, string shapefileName)
        {
            errorMsg = "";
            HMSBaseFlow.BaseFlow bFlow = new HMSBaseFlow.BaseFlow(out errorMsg, startDate, endDate, dataSource, localTime, shapefileName);
            if (errorMsg.Contains("Error")) { return new HMSJSON.HMSJSON.HMSData(); }
            bFlow.GetDataSetsString(out errorMsg);
            if (errorMsg.Contains("Error")) { return new HMSJSON.HMSJSON.HMSData(); }
            return bFlow.jsonData;
        }
    }
