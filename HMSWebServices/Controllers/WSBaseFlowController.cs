...
namespace HMSWebServices.Controllers
{
    ...
    public class WSBaseFlowController : ApiController
    {
        ...
        //        data = result.GetBaseFlowData(out errorMsg, parameters["startDate"], parameters["endDate"], parameters["source"], Convert.ToBoolean(parameters["localTime"]), unzippedShapefile);
        ...
        //public string Post([FromBody]BaseFlow param)
        //{
        //    string data = "";
        //    string errorMsg = "";
        //    if (errorMsg.Contains("Error")) { return errorMsg; }
        ...
        //    {
        //        data = result.GetBaseFlowData(out errorMsg, param.latitude, param.longitude, param.startDate, param.endDate, param.source, Convert.ToBoolean(param.localTime));
        //    }
        //    else
        //    {
        ...
        //        data = result.GetBaseFlowData(out errorMsg, param.startDate.ToString(), param.endDate.ToString(), param.source, Convert.ToBoolean(param.localTime), unzippedShapefile);
        //    }
        //    if (errorMsg.Contains("Error")) { DeleteTempShapefiles(param.ID); return errorMsg; }
