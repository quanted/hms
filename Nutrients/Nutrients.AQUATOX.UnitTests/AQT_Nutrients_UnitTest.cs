...
namespace Nutrients.AQUATOX.UnitTests
{
    ...
    public class AQTTest1
    {
        ...
        public void AQTNutrients_ValidJSON()
        {
            ...
            string filePath = "..\\..\\..\\..\\TEST\\AQUATOX_Nutrient_Model_Valid.JSON";
        ...
        public void AQTNutrients_Check_Data_Requirements()
        {
            ...
            filePath = "..\\..\\..\\..\\TEST\\INVALID\\AQUATOX_Nutrient_Model_pH_NoCO2.txt";
            json = GetTestFile(filePath);
            errmsg = "";
            AQTM = new AQTNutrientsModel(ref json, out errmsg, false);
            errmsg = AQTM.CheckDataRequirements();
            ...
            filePath = "..\\..\\..\\..\\TEST\\INVALID\\AQUATOX_Nutrient_Model_NoVolume.txt";
            json = GetTestFile(filePath);
            errmsg = "";
            AQTM = new AQTNutrientsModel(ref json, out errmsg, false);
            errmsg = AQTM.CheckDataRequirements();
            ...
            filePath = "..\\..\\..\\..\\TEST\\INVALID\\AQUATOX_Nutrient_Model_NH4_no_Nitrate.txt";
            json = GetTestFile(filePath);
            errmsg = "";
            AQTM = new AQTNutrientsModel(ref json, out errmsg, false);
            errmsg = AQTM.CheckDataRequirements();
            ...
            filePath = "..\\..\\..\\..\\TEST\\INVALID\\AQUATOX_Nutrient_Model_NoOxygen.txt";
            json = GetTestFile(filePath);
            errmsg = "";
            AQTM = new AQTNutrientsModel(ref json, out errmsg, false);
            errmsg = AQTM.CheckDataRequirements();
        ...
        private string GetTestFile(string filePath)
        {
            ...
            catch (System.IO.FileNotFoundException)
            {
                ...
                path2 = "/home/travis/build/quanted/hms/Nutrients/TEST";
                ...
                {
                    path2 = Path.Combine("/home/travis/build/quanted/hms/Nutrients/TEST/Invalid", fileName[fileName.Length - 1]);
                }
                json = File.ReadAllText(path2);
            }
            return json;
