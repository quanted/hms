...
namespace SubSurfaceFlow
{
    ...
    public class NLDAS
    {
        ...
        public ITimeSeriesOutput GetData(out string errorMsg, ITimeSeriesOutput output, ITimeSeriesInput input)
        {
            ...
            nldasOutput = nldas.SetDataToOutput(out errorMsg, "SubSurfaceFlow", data, output, input);
            if (errorMsg.Contains("ERROR")) { return null; }
        ...
        /// <summary>
        /// Daily aggregated sums for subsurfaceflow data.
        /// </summary>
        /// <param name="errorMsg"></param>
        /// <param name="output"></param>
        /// <returns></returns>
        public static Dictionary<string, List<string>> DailyAggregatedSum(out string errorMsg, double modifier, ITimeSeriesOutput output, ITimeSeriesInput input, bool averages)
        {
            errorMsg = "";
        ...
        /// <summary>
        /// Monthly aggregated sums for subsurfaceflow data.
        /// </summary>
        /// <param name="errorMsg"></param>
        /// <param name="output"></param>
        /// <returns></returns>
        public static Dictionary<string, List<string>> MonthlyAggregatedSum(out string errorMsg, double modifier, ITimeSeriesOutput output, ITimeSeriesInput input, bool averages)
        {
            errorMsg = "";
