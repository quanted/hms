...
{
    public class HumidityControllerIntegrationTests
    {
        ...
        const string prismRequest =
            "{\"source\": \"prism\",\"relative\": true,\"dateTimeSpan\": {\"startDate\": \"2015-01-01T00:00:00\",\"endDate\": \"2015-12-31T00:00:00\"," +
        ...
        /// </summary>
        public HumidityControllerIntegrationTests()
        {
        ...
        /// <summary>
        /// Humidity controller integration tests for each temperature data source. All tests should pass.
        /// </summary>
