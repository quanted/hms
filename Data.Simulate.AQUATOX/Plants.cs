          ...
          //    {m/s}            {cm/s}                                           {avg}   {m/cm}
                ...
                if (!SloughEvent) // check to see if sloughevent should be initiated
                {
                    if ((NState >= Consts.FirstDiatom) && (NState <= Consts.LastDiatom))
                    {
                        ...
                        {   // frac living
                            SloughEvent = true;
                            SloughLevel = State * (1 - (PAlgalRec.PctSloughed / 100));
        ...
        public double NLimit()
        {
            ...
            else if (AQTSeg.PSetup.Internal_Nutrients)
            {
                ...
                if (N2O > Consts.Tiny)
                {
                    ...
                    NL = (1 - (PAlgalRec.Min_N_Ratio / N2O));
                }
                else
                {
                    NL = 0.0;
...
//         WashoutStep[AQTSeg.DerivStep] = result * AQTSeg.SegVol();
    ...
    public class T_N_Internal_Plant : TStateVariable
    {
       ...
       //  {ug/L d}    {g/g d}    {       unitless            }    {                        unitless                        }   {   mg / L  }  {ug/mg}
        ...
        //public double NutrSegDiff(bool UpLinks)
        //{
        //    double result;
        ...
        //        }
        //        OtherSegCConc = OtherSeg.GetState(NState, T_SVType.StV, T_SVLayer.WaterCol);
        ...
        //            if (CarryDiff > 0)
        //            {
        //                RelevantPlant = OtherSeg.GetStatePointer(NState, SVType, Layer);
        //            }
        //            else
        //            {
        //                RelevantPlant = AQTSeg.GetStatePointer(NState, SVType, Layer);
        //            }
        ...
        //public double NutInCarrierWashin()
        //{
        //    double result;
        //    TPlant PUpstreamCarrier;
        //    int i;
        //    TVolume PUpVol;
        //    TSegmentLink PLnk;
        //    double Junk;
        ...
        //    {
        //        throw new Exception("Programming Error, NutInCarrierWashin must be called by Nut dissolved in Carrier");
        //    }
        //    if (!AQTSeg.LinkedMode)
        //    {
        //        return result;
        //    }
        //    SegVolume = AQTSeg.SegVol();
        //    TCollection 1 = AQTSeg.In_FB_Links;
        ...
        //        {
        //            PUpVol = PLnk.FromPStates.GetStatePointer(AllVariables.Volume, T_SVType.StV, T_SVLayer.WaterCol);
        ...
        //            PUpstreamCarrier = PLnk.FromPStates.GetStatePointer(NState, T_SVType.StV, T_SVLayer.WaterCol);
        //            UpStVolume = PUpVol.AQTSeg.SegVol();
        //            UpStWashout = PUpstreamCarrier.Washout() * UpStVolume;
        //            // Washout is virtual method
        //            if (UpStWashout > 0)
        //            {
        //                result = result + (UpStWashout / SegVolume * PUpstreamCarrier.Nutr_2_Org(SVType) * 1e3 * PctWashThisLink);
        //            }
        //            // ug/L
        //            // mg/L * M3
        //            // M3
        ...
        //    // g/g
        //    // ug/mg
        //    result = CarrierDiff * RelevantPlant.Nutr_2_Org(SVType) * 1e3;
        //    return result;
        //}
