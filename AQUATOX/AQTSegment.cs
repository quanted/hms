...

{
    public class TStateVariable
    {
        ...
        public AQUATOXSegment AQTSeg = null;   // Pointer to Collection of State Variables of which I am a member
        public LoadingsRecord LoadsRec = null;   // Holds all of the Loadings Information for this State Variable  
        public double Loading = 0;         // Loading of State Variable This time step
        ...
        public TAQTSite Location = null;    // Pointer to Site in which I'm located
 ...
 //      public int RateIndex = 0;
...

    {
        ...
        public int DerivStep;    // Current Derivative Step 1 to 6, Don't save in Storload
        public Setup_Record PSetup;

        public bool UseConstEvap = true;
        public TLoadings DynEvap = null;
        public TLoadings DynZMean;
        public DateTime VolumeUpdated; 

        public double Volume_Last_Step;    //Volume in the previous step, used for calculating dilute/conc,  if stratified, volume of whole system(nosave)}
        ...
        public void SetDefaultSetup()
            ...
            public void Derivs(DateTime X, int Step)
            {
                ...
                // SV.CalculateAllLoads(WorkingTStates.TPresent);      // Calculate loads and ensure Morphometry is up-to-date
