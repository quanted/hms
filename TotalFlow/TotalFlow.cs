...
namespace HMSTotalFlow
{
    public class TotalFlow : HMSLDAS.IHMSModule
    {
        ...
        /// <param name="source"></param>
        /// <param name="sfPath"></param>
        public TotalFlow(out string errorMsg, string latitude, string longitude, string startDate, string endDate, string source, bool local, string sfPath)
        {
            errorMsg = "";
            this.gmtOffset = 0.0;
            ...
            //this.surfaceFlowTS = new List<HMSTimeSeries.HMSTimeSeries>();
            //this.baseFlowTS = new List<HMSTimeSeries.HMSTimeSeries>();
        ...
        public string GetDataSetsString(out string errorMsg)
        {
            ...
            string combinedData = output.CombineDatasetsAsJSON(out errorMsg, ts, "TotalFlow", this.dataSource, this.localTime, this.gmtOffset);
            if (errorMsg.Contains("Error")) { return null; }
            return combinedData;
        }
    }
