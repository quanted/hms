...
namespace HMSLandSurfaceFlow
{
    public class LandSurfaceFlow : HMSLDAS.IHMSModule
    {
        ...
        /// <param name="source"></param>
        /// <param name="sfPath"></param>
        public LandSurfaceFlow(out string errorMsg, string latitude, string longitude, string startDate, string endDate, string source, bool local, string sfPath)
        {
            errorMsg = "";
            this.gmtOffset = 0.0;
        ...
        public string GetDataSetsString(out string errorMsg)
        {
            ...
            string combinedData = output.CombineDatasetsAsJSON(out errorMsg, ts, "LandSurfaceFlow", this.dataSource, this.localTime, this.gmtOffset);
            if (errorMsg.Contains("Error")) { return null; }
            return combinedData;
        }
    }
