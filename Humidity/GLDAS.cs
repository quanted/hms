...
namespace Humidity
{
    public class GLDAS
    {
        ...
        public ITimeSeriesOutput GetData(out string errorMsg, ITimeSeriesOutput output, ITimeSeriesInput input)
        {
            ...
            List<string> data = gldas.GetData(out errorMsg, "humidity", input);


            ITimeSeriesOutput gldasOutput = gldas.SetDataToOutput(out errorMsg, "Specific Humidity", data, output, input);

            switch (input.TemporalResolution)
            {
                case "monthly":
                    gldasOutput.Data = DailyValues(out errorMsg, 1.0, output, input);
                    gldasOutput.Data = MonthlyAverage(out errorMsg, 7, 1.0, output, input);
                    break;
                case "daily":
                case "default":
                default:
            ...
            gldasOutput.Metadata["column_1"] = "date";
            gldasOutput.Metadata["column_2"] = "specifichumidity";
            gldasOutput.Metadata["column_2_units"] = "kg/kg";

            return gldasOutput;
        }

        /// <summary>
        /// Daily aggregated sums for humidity data.
        /// </summary>
        /// <param name="errorMsg"></param>
        /// <param name="output"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Validate input dates and coordinates for gldas data.
        /// </summary>
        /// <param name="input"></param>
        /// <param name="errorMsg"></param>
        /// <returns></returns>
